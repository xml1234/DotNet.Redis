...
namespace RedisDemo
{
    public partial class _Default : Page
    {
        ...
        {
            //System.Diagnostics.Process.Start("C:\\redis\\redis-server.exe");//此处为Redis的存储路径
            System.Diagnostics.Process.Start("D:\\安装包\\redis安装包\\Redis-x64-3.2.100\\redis-server.exe");//此处为Redis的存储路径
